...
Most of these come down to network reality or how thegradient serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

thegradient rate-limits like any public site. thegradient already paces
...
Where a surface is gated, thegradient reads a cookie or token you supply
...
`thegradient`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what thegradient actually did
